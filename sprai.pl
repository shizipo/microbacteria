...
my $wgs="/media/data/software/Celera_Assembler/wgs-8.3rc2/Linux-amd64/bin";
my $blast="/media/data/software/blast+/ncbi-blast-2.6.0+/bin/";
my $sprai="/media/data/software/sprai/sprai-v0.9.9.23/bin/";
my $qsub="/public/hstore1/works/yangxinchao/OE2018H0675V/qsub-pbs.pl";
my $glibc="export LD_LIBRARY_PATH=/media/data/software/glibc/glibc-v2.14/lib/:\$LD_LIBRARY_PATH";
$minlen||=500;
$outdir||=getcwd;
$queue||="cu";
$use||=1;
